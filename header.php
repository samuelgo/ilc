...
<body <?php body_class(); ?>>
<!--[if lt IE 9]>
   <div style='width:100%; background-color:#171515; color:#fff;'>
    Estás usando un navegador antiguo <b>no soportado por esta Web</b>, para utilizar sin problemas tu ILC Life Coach te recomendamos
    encarecidamente actualizar a <a href="http://www.whatbrowser.org/intl/es/"  style='color:#C3C3C3;'>cualquier navegador moderno.</a>
    </div>     
<![endif]-->
                ...
                <div class="row">
                    <div class="site-logo left">
                        <a href="<?php echo SITE_URL; ?>" rel="home">
                            <img src="<?php echo ThemexCore::getOption('site_logo', THEME_URI.'images/logo.png'); ?>" alt="<?php bloginfo('name'); ?>" /> <h1 class="inset-text"><?php bloginfo('name'); ?></h1>
                        </a>
                    </div>
                    <!-- /logo -->
                        ...
                        <?php if(is_user_logged_in()) { ?>
                            <div class="button-wrap left">
                                <a href="<?php echo wp_logout_url(SITE_URL); ?>" class="button dark">
                                    <!-- Texto 'Cerrar sesión' -->
                                    <span class="button-icon logout"></span><?php _e('Cerrar sesión','academy'); ?>
                                </a>                            
                            </div>
                            <div class="button-wrap left">
                                <a href="<?php echo ThemexUser::$data['user']['profile_url']; ?>" class="button">
                                    <!-- Texto 'Mi Perfil'-->
                                    <span class="button-icon register"></span><?php _e('Mi Perfil','academy'); ?>
                                </a>                        
                            </div>                          
                            <?php } else { ?>                       
                            <div class="button-wrap left tooltip login-button">
                                <!--Texto Iniciar sesión-->
                                <a href="#" class="button dark"><span class="button-icon login"></span><?php _e('Iniciar sesión','academy'); ?></a>
                                <div class="tooltip-wrap">
                                    <div class="tooltip-text">
                                        <form action="<?php echo AJAX_URL; ?>" class="ajax-form popup-form" method="POST">
                                            ...
                                            <div class="button-wrap left">
                                                <a href="<?php echo home_url('?facebook_login=1'); ?>" title="<?php _e('Sign in with Facebook','academy'); ?>" class="button facebook-button">
